...
class Ui_Qt_CV_MainWindow(object):
	def setupUi(self, Qt_CV_MainWindow):
		...
		self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 20, 501, 122))
		...
		self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(530, 20, 91, 121))
